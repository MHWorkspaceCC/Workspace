...
# deploy.ps1
#
$resourceGroupName = 'rg-db-ws-pd-pri'
$location = "westus"
...
$templateFile = $currentDir + '\Deploy-DB\db-azuredeploy.json'
$templateParametersFile = $currentDir + '\Deploy-DB\db-azuredeploy.parameters.json'
