...
function Login-WsProfile{
	Write-Host "In: " $MyInvocation.MyCommand 

    $currentDir = (Get-Item -Path ".\" -Verbose).FullName
	$profileFile = $currentDir + "\" + $wsAcctInfo['profileFile']
	...
	Try{
        ...
        #$aa = Get-AzureRmAutomationAccount -ResourceGroupName "rg-oms-as0p" -Name "devops-automation"
